...
window.Day4NoteScene = class Day4NoteScene extends Phaser.Scene {
  ...
  ask(question, savePath, onDone) {
    ...
    const field = TextInput.open(this, {
      ...
      placeholder: DAY04.note.placeholder, depth: 1200
    });
    ...
    if (field) {
      layer.add(UI.button(this, W / 2, 452, 260, 60, '적었어요', () => done(true),
        { size: FONT.label, fill: PAL.sun }));
      layer.add(UI.button(this, W / 2, 526, 260, 54, DAY04.note.skip, () => done(false),
        { size: FONT.small }));
